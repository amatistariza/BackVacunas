namespace API.Domain.DTOs
{
    ...
    {
        [Key]
        public int Id { get; set; } // Identificador �nico de la condici�n

        [Required]
        [StringLength(100)]
        public string Condicion { get; set; } // Condici�n de la usuaria (obligatorio)

        public bool Gestante { get; set; } // Indica si la usuaria est� gestante

        public DateTime? FechaUltimaMenstruacion { get; set; } // Fecha de �ltima menstruaci�n (opcional)

        public int? SemanasGestacion { get; set; } // Semanas de gestaci�n (opcional)
    ...
    {
        [Key]
        public int Id { get; set; } // Identificador �nico del antecedente m�dico

        [Required]
        public bool ContraindicacionVacunacion { get; set; } // �Sufre o ha sufrido algo que contraindique la vacunaci�n?

        [StringLength(500)]
        public string DetalleContraindicacion { get; set; } // Detalle de la contraindicaci�n (opcional)

        [Required]
        public bool ReaccionBiologicos { get; set; } // �Ha presentado reacci�n moderada o severa a biol�gicos anteriores?

        [StringLength(500)]
        public string DetalleReaccion { get; set; } // Detalle de la reacci�n a biol�gicos (opcional)
    }

    public class EsquemaVacunaDTO
    {
        [Key]
        public int Id { get; set; } // Identificador �nico del esquema
